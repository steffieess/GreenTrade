...
if (isset($_SESSION['usuarios_rut'])) {
    ...
    $sqlUserM="SELECT u.rut_usuario, u.nom_usuario, e.mail_empresa, e.id_empresa, u.tipo_usu_id_tipousu, e.usuario_empresa, u.mail_usuario FROM usuario u INNER JOIN empresa e on u.empresa_id_empresa  = e.id_empresa  WHERE u.rut_usuario = '$rutUserM'";
