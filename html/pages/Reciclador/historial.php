...
<?php
$querySoli = "SELECT * FROM solicitud WHERE empresa_id_empresa = '$idEmpresaM' AND estado != 'Pendiente' AND fecha_recicladora != 'null'";
...
<section>
    <h1 class="heading-title"> Historial </h1>
                    ...
                    <?php if (mysqli_num_rows($querySoliList) != 0) { ?>
                        <?php while ($dataSoli = mysqli_fetch_array($querySoliList)) { ?>
                            <tr>
                                ...
                                <td><a href="../../../html/pages/Reciclador/verHistorial.php?id_imp_exp=<?php echo $imp_exp_id_imp_exp ?>"><i class="fa-solid fa-eye"></i></a></td>
                            </tr>
                        <?php } ?>
                    <?php } ?>
                </tbody>
