    ...
    <div>
        <form action="../../func/tools/registrarSuppliers.php" id='regUser' class='input-group-regUser' method="POST">
            ...
            <div class="content">
                ...
                <input name="nomUsuario" type="text" class='input-field' placeholder="Nombre Usuario" required autocomplete="off">
            </div>
            <div class="content">
            ...
            <div class="content">
                ...
                <input name="mailUsuario" type="text" class='input-field' placeholder="greentrade@greentrade.com" required autocomplete="off">
            </div>
            <div class="content">
